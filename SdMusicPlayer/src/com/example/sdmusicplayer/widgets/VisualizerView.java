...
import com.example.sdmusicplayer.helpers.visualizer.AudioData;
import com.example.sdmusicplayer.helpers.visualizer.BarGraphRenderer;
import com.example.sdmusicplayer.helpers.visualizer.FFTData;
import com.example.sdmusicplayer.helpers.visualizer.Renderer;
import com.example.sdmusicplayer.helpers.visualizer.SolidBarGraphRenderer;
import com.example.sdmusicplayer.helpers.visualizer.WaveformRenderer;
...
public class VisualizerView extends View {
  ...
  public VisualizerView(Context context, AttributeSet attrs, int defStyle)
  {
    ...
    if( type.equals(getResources().getString(R.string.visual_solidbargraph)) ){
        ...
        mRenderer = (Renderer) new WaveformRenderer(context);
    	
    }
    else if ( type.equals(getResources().getString(R.string.visual_bargraph)) ){

    	mRenderer = (Renderer) new BarGraphRenderer(context);
