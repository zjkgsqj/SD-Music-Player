...
import com.example.sdmusicplayer.MainActivity;
...
public class MediaButtonIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intentAction)) {
            ...
            int buttonId = intent.getIntExtra(MusicService.CMDNOTIF, 0);
            ...
            if (command != null) {
                if (action == KeyEvent.ACTION_DOWN) {
                    if (mDown && (buttonId == 0)) {
                        if ((MusicService.CMDTOGGLEPAUSE.equals(command) || MusicService.CMDPLAY
                                .equals(command))
                                && mLastClickTime != 0
                        ...
                        Intent i = new Intent(context, MusicService.class);
                        i.setAction(MusicService.SERVICECMD);
                        i.putExtra(MusicService.CMDNOTIF, buttonId);
